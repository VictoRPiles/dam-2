...
class Inventory(models.Model):
    # ########## Odoo Fields ##########
    _name = 'shopping_cart.inventory'
    _description = 'shopping_cart.inventory'
    ...
    # ########## Foreign Keys ##########
    buy_ids = fields.One2many(comodel_name = 'shopping_cart.purchase', inverse_name = 'inventory_id',
                              string = 'Purchases')
...
class Client(models.Model):
    # ########## Odoo Fields ##########
    _name = 'shopping_cart.client'
    _description = 'shopping_cart.client'
    ...
    purchase_ids = fields.One2many(comodel_name = 'shopping_cart.purchase', inverse_name = 'client_id',
                                   string = 'Purchases')
...
class Purchase(models.Model):
    # ########## Odoo Fields ##########
    _name = 'shopping_cart.purchase'
    _description = 'shopping_cart.purchase'
    ...
    inventory_id = fields.Many2one(comodel_name = 'shopping_cart.inventory', string = 'Inventory',
                                   required = True, domain = [('quantity', '>', '0')])
    client_id = fields.Many2one(comodel_name = 'shopping_cart.client', string = 'Client', required = True)
